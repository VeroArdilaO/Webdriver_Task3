const ComputeEngine = require('../../src/Components/shareddisplay.component')
const SharedWindowDisplay = require('../../src/Components/computeEnging.component')
...
module.exports = new GoogleCloudCalculator()